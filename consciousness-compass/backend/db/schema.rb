...
ActiveRecord::Schema[8.0].define(version: 2025_05_09_221458) do
  ...
  create_table "resource_links", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["subsection_id"], name: "index_resource_links_on_subsection_id"
  end
  ...
  add_foreign_key "resource_links", "subsections"
